...
to find the previous greater element for each element of the array in order of their appearance in the array.
...
int main() {
    ...
    int arr[n];
    printf("Enter %d array elements separated by space: ", n);
    for (i = 0; i < n; i++) {
        scanf("%d", &arr[i]);
    }
...
Enter 4 array elements separated by space: 1 3 2 4
Previous Greater Elements: -1,-1,3,-1
